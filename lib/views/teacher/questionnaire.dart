...
class ProficientQuestionnaire extends StatefulWidget {
  ...
  final nextFunction;
  final scrollController;
  ProficientQuestionnaire(
      {required this.step,
      required this.nextFunction,
      required this.scrollController});
  @override
  _ProficientQuestionnaireState createState() =>
      _ProficientQuestionnaireState();
}
...
class HighProficientQuestionnaire extends StatefulWidget {
  ...
  final nextFunction;
  final scrollController;
  HighProficientQuestionnaire(
      {required this.step,
      required this.nextFunction,
      required this.scrollController});
  @override
  _HighProficientQuestionnaireState createState() =>
      _HighProficientQuestionnaireState();
}

class _HighProficientQuestionnaireState
    extends State<HighProficientQuestionnaire> {
  @override
  void initState() {
    super.initState();
  }
